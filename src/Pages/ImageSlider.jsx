...
const ImageSlider = () => {
  ...
  return (
    <div className='max-w-[1400px] h-[580px] w-full m-auto  py-16 px-4  relative group'>
      ...
      ></div>
      {/* left  arrow */}
      <div className='absolute rounded-full text-2xl p-2 text-black top-[50%] -translate-x-0 translate-y-[-50%] left-5 cursor-pointer '>
        <BsChevronCompactLeft size={30} onClick={prevSlide} />
      </div>
      {/* right side */}
      <div className='absolute rounded-full text-2xl p-2 text-black top-[50%] -translate-x-0 translate-y-[-50%] right-5 cursor-pointer'>

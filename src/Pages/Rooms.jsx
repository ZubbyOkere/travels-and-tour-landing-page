...
const Rooms = () => {
  return (
    <div className='max-w-[1400px] m-auto h-[500px] bg-blue-100 mx-auto my-20 pt-16 lg:mb-[30%] md:mb-[35%] px-4 grid lg:grid-cols-3'>
      <div className='lg:top-20 relative lg:col-span-1 col-span-2'>
        <h3>Fine Interior rooms</h3>
        <p>
          Fine Interior rooms Lorem ipsum dolor sit amet, consectetur
